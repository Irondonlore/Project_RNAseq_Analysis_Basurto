################################################################################
###### SCALE-FREE TOPOLOGY FOR JOINT ANALYSIS OF DATA AC-45_RNAseq-FFPE ########
################################################################################
...
if (length(powers) != 0){
  ...
  #R^2
  sizeGrWindow(9,5)
  pdf(file = paste(results.file,"Images/1_Pearson_SoftThreshold_vs_ScaleFreeTopology_and_MeanConnectivity.pdf", sep = ""), width = 9, height = 5)
  par(mfrow=c(1,2))
  cex1= 0.9
  ...
  #R^2
  sizeGrWindow(9,5)
  pdf(file = paste(results.file, "Images/1_Bicor_SoftThreshold_vs_ScaleFreeTopology_and_MeanConnectivity.pdf", sep =""), width = 9, height = 5)
  par(mfrow=c(1,2))
  cex1= 0.9
  ...
  save(sft_pearson, sft_bicor, file = paste(results.file,"Data/", tag, "_sft_pearson_bicor.RData", sep =""))
